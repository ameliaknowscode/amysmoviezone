    ...
    <form method="POST" action="{{ route('watchlist.privacy') }}" class="mt-6">
        ...
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-xs text-zinc-500">Hides your ratings, watchlists, and reviews</p>
            </div>
            <label class="relative inline-flex items-center cursor-pointer">
                ...
                <span class="ms-3 text-sm text-zinc-500">{{ $user->profile_private ? 'Private' : 'Public' }}</span>
            </label>
        </div>
