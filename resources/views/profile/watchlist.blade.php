<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            <a href="{{ route('profile.show', $profileUser->username) }}" class="hover:text-indigo-600 transition-colors">{{ $profileUser->name }}</a>'s Watchlist
        </h2>
    </x-slot>
    ...
    <div class="py-12">
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8 space-y-8">
            ...
            {{-- Want to Watch --}}
            @if($wantToWatch !== null)
            <div id="want-to-watch" class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    <h3 class="text-lg font-semibold text-gray-800 mb-4">Want to Watch</h3>
                        ...
                        <ul class="divide-y divide-gray-100">
                            ...
                            <li class="py-3 flex items-center gap-4">
                                ...
                                <div class="flex-1 min-w-0">
                                    <a href="{{ $entry->movie->publicUrl() }}" class="text-sm font-medium text-indigo-600 hover:underline">
                                        {{ $entry->movie->title }}
                                    </a>
            ...
            {{-- Watched --}}
            @if($watched !== null)
            <div id="watched" class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    <h3 class="text-lg font-semibold text-gray-800 mb-4">Watched</h3>
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-sm text-gray-500">This user's watchlists are private.</div>
            </div>
            @endif
