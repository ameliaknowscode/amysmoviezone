            ...
            <div class="card">
                <div class="p-6 text-zinc-100">
                    ...
                    <div class="mb-5 p-3 bg-zinc-900 border border-zinc-800 rounded-md">
                        ...
                        <pre class="text-xs font-mono text-zinc-300">movie_title,release_year,type,character
...
Adaptation,2002,Actor|Director|Actor,Charlie|Donald</pre>
                            ...
                            <table class="w-full text-sm border-collapse">
                                <thead>
                                    <tr class="bg-zinc-800 text-left">
                                        ...
                                        <th class="border border-zinc-800 px-3 py-2 font-medium text-zinc-400">Movie</th>
                                ...
                                <tbody>
                                    @foreach($rowErrors as $rowError)
                                        <tr class="hover:bg-zinc-800">
                                            ...
                                            <td class="border border-zinc-800 px-3 py-2">{{ $rowError['movie'] }}</td>
            ...
            <div>
                <a href="{{ route('admin.people.edit', $person) }}" class="text-amber-400 hover:underline text-sm">&larr; Back to {{ $person->name }}</a>
            </div>
