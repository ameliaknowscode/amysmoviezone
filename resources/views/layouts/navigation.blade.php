<nav x-data="{ open: false, searchOpen: false }" class="bg-zinc-950 border-b border-zinc-800">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-dropdown align="left" width="48">
                        <x-slot name="trigger">
                            <button class="inline-flex items-center px-1 pt-1 border-b-2 {{ request()->routeIs('admin.*', 'dashboard') ? 'border-amber-400 text-amber-400' : 'border-transparent text-zinc-400 hover:text-zinc-100 hover:border-zinc-600' }} text-sm font-medium leading-5 focus:outline-none transition duration-150 ease-in-out">
                                {{ __('Admin') }}
                                <svg class="ms-1 fill-current h-4 w-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
                                    <path fill-rule="evenodd" d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z" clip-rule="evenodd" />
                                </svg>
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6 gap-2">
                <button
                    ...
                    class="inline-flex items-center gap-1 px-3 py-2 text-sm text-zinc-500 hover:text-zinc-300 focus:outline-none transition"
                    aria-label="Search"
                >
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                ...
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        ...
                        <button class="inline-flex items-center gap-2 px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-zinc-400 hover:text-zinc-200 focus:outline-none transition ease-in-out duration-150">
                            <div class="relative">
                                @if(Auth::user()->avatar)
                                ...
                                @endif
                                @if($unreadCount > 0)
                                    <span class="absolute -top-1 -right-1 h-3.5 w-3.5 rounded-full bg-red-500 border-2 border-zinc-950 flex items-center justify-center">
            ...
            <div class="-me-2 flex items-center sm:hidden">
                <button @click="open = ! open" class="inline-flex items-center justify-center p-2 rounded-md text-zinc-400 hover:text-zinc-200 hover:bg-zinc-800 focus:outline-none focus:bg-zinc-800 transition duration-150 ease-in-out">
    ...
    >
        ...
        >
            <h3 class="text-lg font-semibold text-zinc-100 mb-4">Search movies &amp; people</h3>
            ...
            <div class="mt-4 text-right">
                <button @click="searchOpen = false" class="text-sm text-zinc-500 hover:text-zinc-300">Cancel</button>
            </div>
        </div>
    </div>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <div class="px-4 pt-2 pb-1 text-xs font-semibold uppercase tracking-widest text-zinc-600">Explore</div>
            ...
            @auth
            <div class="px-4 pt-3 pb-1 text-xs font-semibold uppercase tracking-widest text-zinc-600">My Zone</div>
