                    ...
                    <form method="POST" action="{{ route('admin.movies.update', $movie) }}" enctype="multipart/form-data">
                        ...
                        <div class="mb-6">
                            ...
                            <div class="mb-4">
                                ...
                                <textarea id="synopsis" name="synopsis" rows="4"
                                    class="w-full max-w-2xl border-zinc-700 rounded-md shadow-sm">{{ old('synopsis', $movie->synopsis) }}</textarea>
                            </div>
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" id="country" name="country" value="{{ old('country', $movie->country) }}"
                                    class="w-full max-w-md border-zinc-700 rounded-md shadow-sm">
                            </div>

                            <div class="mb-4">
                                <label for="language" class="block font-medium text-sm text-zinc-300 mb-1">Language</label>
                                <input type="text" id="language" name="language" value="{{ old('language', $movie->language) }}"
                                    class="w-full max-w-md border-zinc-700 rounded-md shadow-sm">
                            </div>

                            <div class="mb-4">
                                <label for="imdb_url" class="block font-medium text-sm text-zinc-300 mb-1">IMDb URL</label>
                                <input type="url" id="imdb_url" name="imdb_url" value="{{ old('imdb_url', $movie->imdb_url) }}"
                            ...
                            <div class="mb-4">
                                ...
                                <input type="url" id="letterboxd_url" name="letterboxd_url" value="{{ old('letterboxd_url', $movie->letterboxd_url) }}"
                        ...
                        <div class="mb-4">
                            <a href="{{ route('admin.movies.credits.import', $movie) }}"
                               class="text-sm text-amber-400 hover:underline">↑ Import Credits from CSV</a>
                        </div>
