            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <div class="mb-5 p-3 bg-gray-50 border border-gray-200 rounded-md">
                        ...
                        <pre class="text-xs font-mono text-gray-700">person_name,type,character
...
Keanu Reeves,Actor|Director,Neo</pre>
                            ...
                            <table class="w-full text-sm border-collapse">
                                <thead>
                                    <tr class="bg-gray-100 text-left">
                                        ...
                                        <th class="border border-gray-200 px-3 py-2 font-medium text-gray-600">Person</th>
                                ...
                                <tbody>
                                    @foreach($rowErrors as $rowError)
                                        <tr class="hover:bg-gray-50">
                                            ...
                                            <td class="border border-gray-200 px-3 py-2">{{ $rowError['person'] }}</td>
            ...
            <div>
                <a href="{{ route('admin.movies.edit', $movie) }}" class="text-indigo-600 hover:underline text-sm">&larr; Back to {{ $movie->title }}</a>
            </div>
