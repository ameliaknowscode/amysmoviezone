<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">Genres</h2>
    </x-slot>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <div class="mb-4">
                        <a href="{{ route('admin.genres.create') }}" class="text-indigo-600 hover:underline">+ Add Genre</a>
                    </div>
                                ...
                                <tbody>
                                    @foreach($genres as $genre)
                                        <tr class="hover:bg-gray-50">
                                            ...
                                            <td class="border border-gray-300 px-4 py-2 text-gray-500 text-sm">{{ $genre->slug }}</td>
                                            <td class="border border-gray-300 px-4 py-2 text-center">
                                                <div class="flex items-center justify-center gap-3">
                                                    <a href="{{ route('admin.genres.edit', $genre) }}" class="text-indigo-500 hover:text-indigo-700" title="Edit genre">
