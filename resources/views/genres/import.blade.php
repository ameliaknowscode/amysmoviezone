            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <div class="mb-5 p-3 bg-gray-50 border border-gray-200 rounded-md">
                        ...
                        <pre class="text-xs font-mono text-gray-700">title,release_year,genres
The Matrix,1999,Action|Science Fiction
Parasite,2019,Drama|Thriller
Toy Story,1995,Animation|Comedy|Family</pre>
                        <p class="text-xs text-gray-500 mt-2">
                            Use <code class="bg-gray-100 px-1 rounded font-mono">|</code> to separate multiple genres.
            ...
            <div>
                <a href="{{ route('admin.genres.index') }}" class="text-indigo-600 hover:underline text-sm">&larr; Back to genres</a>
            </div>
